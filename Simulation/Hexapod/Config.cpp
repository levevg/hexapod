...
void Config::loadConfiguration()
{
    ...
    Geometry g {};
    g.tipToWrist = Config::getValue<float>("TIP_TO_WRIST");
    g.wristToKnee = Config::getValue<float>("WRIST_TO_KNEE");
    g.kneeToShoulder = Config::getValue<float>("KNEE_TO_SHOULDER");
    g.centerToShoulder = Config::getValue<float>("CENTER_TO_SHOULDER");
    g.kneeToBottom = Config::getValue<float>("KNEE_TO_BOTTOM");
